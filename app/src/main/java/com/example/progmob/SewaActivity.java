...
public class SewaActivity extends AppCompatActivity {
    ...
    String list_mobil[] = {"Toyota Avansa","Daihatsu Xenia","Mitsubisi Pajero","Toyota Supra"};
    ...
    public void tombol_sewa2(View view) {
        ...
        if (jml_uang < ttl_hargasewa) {
            ...
            Intent intent = new Intent(SewaActivity.this,StrukActivity.class);
    ...
    public void hal_utama(View view) {
        Intent intent = new Intent(SewaActivity.this,MainActivity.class);
        startActivity(intent);
    }
}